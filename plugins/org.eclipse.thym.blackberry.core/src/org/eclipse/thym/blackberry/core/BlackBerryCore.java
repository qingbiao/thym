 ...
 */
public class BlackBerryCore implements BundleActivator, DebugOptionsListener {

	// The plug-in ID
	public static final String PLUGIN_ID = "org.eclipse.thym.blackberry.core"; //$NON-NLS-1$
	...
	public void start(BundleContext context) throws Exception {
		BlackBerryCore.context = context;
	...
	public void stop(BundleContext context) throws Exception {
		BlackBerryCore.context = null;
	}
	
	public static String getSDKLocation(){
		return Platform.getPreferencesService().getString("org.eclipse.thym.ui", BlackBerryConstants.PREF_BLACKBERRY_SDK_LOCATION, null, null);
	}
