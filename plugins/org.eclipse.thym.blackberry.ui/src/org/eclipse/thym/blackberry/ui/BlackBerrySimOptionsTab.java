...
import static org.eclipse.thym.blackberry.core.bdt.BlackBerryLaunchConstants.ATTR_SIMULATOR_NAME;
import static org.eclipse.thym.blackberry.core.bdt.BlackBerryLaunchConstants.ATTR_LOGCAT_FILTER;
import static org.eclipse.thym.blackberry.core.bdt.BlackBerryLaunchConstants.VAL_DEFAULT_LOGCAT_FILTER;
...
import org.eclipse.thym.blackberry.core.bdt.BlackBerryAPILevelComparator;
import org.eclipse.thym.blackberry.core.bdt.BlackBerryAVD;
...
public class BlackBerrySimOptionsTab extends AbstractLaunchConfigurationTab {
	private Text textProject;
	private Text logFilterTxt;
	private Listener dirtyListener;
	private Combo AVDCombo;
	private List<BlackBerryAVD> avds;
	...
	public BlackBerrySimOptionsTab() {
	...
	public void initializeFrom(ILaunchConfiguration configuration) {
		...
		try{
			String avd = configuration.getAttribute(ATTR_SIMULATOR_NAME, "");
	...
	public void performApply(ILaunchConfigurationWorkingCopy configuration) {
		...
		configuration.setAttribute(ATTR_SIMULATOR_NAME, avd);
	...
	private boolean isTabValid() {
		...
		if(avd != null && !avd.isEmpty()){
			...
			for (BlackBerryAVD blackberryAVD : avds) {
				if(blackberryAVD.getName().equals(avd) 
						&& alc.compare(blackberryAVD.getApiLevel(), BlackBerryConstants.REQUIRED_MIN_API_LEVEL) <0){
